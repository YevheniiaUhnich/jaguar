...
import { rankStandings } from "../utils/rank";
import { Link } from "react-router-dom";

export default function StatsChUkU13() {
  const rows = rankStandings(standingsU13);
  if (!rows?.length) return null;
  return (
    <section>
      <div className="container">
        <h2 className="titleChUk">
          Чемпіонат України з хокею <br></br>серед юнаків 2013-2014 року
        ...
        <div className="details-btn-wrap">
          <Link
            to="/stats-ch-uk-u13"
            className="details-btn details-btn--green-gold"
          >
            <span>Дивитися детально по турам</span>
